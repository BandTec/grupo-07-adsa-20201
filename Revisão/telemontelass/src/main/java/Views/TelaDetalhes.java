...
import Entities.DadosCpu;
import Entities.DadosMemoria;
import Entities.DadosProcessos;
...
public class TelaDetalhes extends javax.swing.JFrame {
    ...
    DadosMemoria dadosMem = new DadosMemoria();
    DadosProcessos dadosProc = new DadosProcessos();
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            public void run() {
                try {
                    ...
                    int cpu = (int) dadosCpu.getCpuUsage();
                    int ram = (int) dadosMem.getMemAvailable();
                    ...
                    lblSo.setText(dadosProc.getOs().toString());
                    
                    DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
                    List<String> list = dadosProc.getOsProcesses();
